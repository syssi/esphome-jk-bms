...
void HeltecBalancerBle::decode_cell_info_(const std::vector<uint8_t> &data) {
  ...
  // @FIXME:  Warn bits and NTC warn bits, warn9, warn10, tempStamp
  // 229  20   0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00
  // 249  20   0x00 0x00 0x00 0x00 0x00 0x76 0x2E 0x09 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00
  // 269  20   0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00
  // 289   9   0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00 0x00
  // 298   1   0xB6
  // 299   1   0xFF
