...
void JkBms::on_status_data_(const std::vector<uint8_t> &data) {
  ...
  this->publish_state_(this->total_voltage_sensor_, (float) jk_get_16bit(offset + 3 * 3) * 0.01f);
  ...
  this->publish_state_(this->current_sensor_,
  ...
  // this->publish_state_(this->battery_capacity_setting_sensor_, (float) jk_get_32bit(offset + 10 + 3 * 36));
