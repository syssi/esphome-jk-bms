...
SWITCHES = {
    CONF_CHARGING: 0x70,                        #0x1000 -> 0x0078
    CONF_DISCHARGING: 0x74,                     #02.10.10.78.00.02.   04.  00.00.00.00.37.A9
    CONF_BALANCING: 0x78,                       #02.10.10.78.00.02.   04.  00.00.00.01.F6.69.

    CONF_HEATING: 0x14,  
    CONF_DISABLE_TEMPERATURE_SENSORS: 0x14,     #0x1000 -> 0x0114
    CONF_GPS_HEARTBEAT: 0x14,                   #DISPLAY ALWAYS ON  (0x0114)
    CONF_PORT_SELECTION: 0x14,                  #02.10.11.14.00.01.   02.  02.00.   B1.D5.   OFF
    CONF_DISPLAY_ALWAYS_ON: 0x14,               #02.10.11.14.00.01.   02.  02.10.   B0.19.   ON   0000 0010 0001 0000
    CONF_SPECIAL_CHARGER:0x14,                  #SMART SLEEP ON
    CONF_SMART_SLEEP_ON: 0x14,                  #02.10.11.14.00.01.   02.  00.10.   B1.79.
    CONF_DISABLE_PCL_MODULE: 0x14,              
