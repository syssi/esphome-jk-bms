...
void JkBmsBle::dump_config() {  // NOLINT(google-readability-function-size,readability-function-size)
  ...
  LOG_SENSOR("", "Cell Voltage 24", this->cells_[24].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 25", this->cells_[25].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 26", this->cells_[26].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 27", this->cells_[27].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 28", this->cells_[28].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 29", this->cells_[29].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 30", this->cells_[30].cell_voltage_sensor_);
  LOG_SENSOR("", "Cell Voltage 31", this->cells_[31].cell_voltage_sensor_);
  ...
  LOG_SENSOR("", "Cell Resistance 24", this->cells_[24].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 25", this->cells_[25].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 26", this->cells_[26].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 27", this->cells_[27].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 28", this->cells_[28].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 29", this->cells_[29].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 30", this->cells_[30].cell_resistance_sensor_);
  LOG_SENSOR("", "Cell Resistance 31", this->cells_[31].cell_resistance_sensor_);
